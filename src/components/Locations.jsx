    ...
    <section id="enderecos" className="bg-mist">
      <div className="mx-auto max-w-[1400px] px-5 py-14 md:px-8 lg:px-12 lg:py-16">
        ...
        <div className="mt-12 grid items-stretch gap-5 lg:mt-14 lg:grid-cols-2 lg:gap-6">
          {/* Online — claro */}
          <Rise delay={1}>
            <article className="relative flex h-full flex-col overflow-hidden bg-porcelain text-espresso ring-1 ring-espresso/10">
          ...
          <Rise delay={2}>
            <article className="relative flex h-full flex-col overflow-hidden bg-espresso text-porcelain">
              ...
              <div className="relative flex flex-1 flex-col border-t border-porcelain/10 p-6 text-center md:p-8 md:text-left">
                ...
                {presencial.address ? (
                  <div className="mt-6 border border-clay/40 border-l-2 bg-espresso-soft/80 px-4 py-3.5 text-center md:text-left">
